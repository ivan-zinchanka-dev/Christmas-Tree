...
namespace Services.Inventory
{
    public class InventoryService
    {
        ...
        private readonly Dictionary<DecorationType, int> _inventory = new Dictionary<DecorationType, int>();
        private readonly Dictionary<DecorationType, ObjectPool> _objectPools = new Dictionary<DecorationType, ObjectPool>();
        ...
        public InventoryService(InventoryConfig inventoryConfig)
        {
            ...
            foreach (DecorationData data in _inventoryConfig.Inventory)  // TODO To Enumerator
            {
