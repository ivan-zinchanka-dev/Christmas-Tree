...
namespace Services.Inventory
{
    ...
    {
        [SerializeField] private List<DecorationData> _inventory;
        [SerializeField] private DecorationData _star;
        [SerializeField] private List<DecorationType> _massiveDecorations;
        ...
        // to Enumerator
        public List<DecorationData> Inventory => new List<DecorationData>(_inventory);
